...
RESULT_CSV = os.path.join(RESULT_DIR, "result_ARIMA.csv")
...
# ================= ARIMA TRAINING =================
def trainmodel_arima(stock_data):
...
def main(data, s_index):
    ...
    result, train_time, test_time = trainmodel_arima(tdata)
    train_end = time.time()
...
if __name__ == "__main__":
    ...
    if all_data == 1:
        ...
        print("\n==============================")
        print("📊 ARIMA AGGREGATED RESULTS")
        print("==============================")
