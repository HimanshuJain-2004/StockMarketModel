...
RESULT_CSV = os.path.join(RESULT_DIR, "result_REGCN.csv")
...
def regcn_loss(y_true, y_pred, prev_price):
    ...
    return r_mse * mse + 0.3 * r_acc * trend_loss
...
def trainmodel(tdata, tadj, s_index, lr, n_neurons,
    ...
    cell = gcgru(max(32, n_neurons // 2), Madj, n_gcn_nodes, 3)
...
if __name__ == '__main__':
    if all_data == 1:
        ...
        print("\n==============================")
        print("📊 REGCN AGGREGATED RESULTS")
        print("==============================")
