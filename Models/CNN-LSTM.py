...
RESULT_CSV = os.path.join(RESULT_DIR, "result_CNN_LSTM.csv")
...
# ================= CNN-LSTM MODEL =================
def trainmodel_cnn_lstm(stock_data):
...
def main(data, s_index):
    ...
    # -------- TRAIN MODEL --------
    preds, train_time, test_time = trainmodel_cnn_lstm(tdata)
...
if __name__ == "__main__":
    ...
    if all_data == 1:
        ...
        print("\n==============================")
        print("📊 CNN-LSTM AGGREGATED RESULTS")
        print("==============================")
