...
RESULT_CSV = os.path.join(RESULT_DIR, "result_LSTM.csv")
...
# ================= LSTM MODEL =================
def trainmodel_lstm(stock_data):
...
def main(data, s_index):
    ...
    # -------- TRAIN MODEL --------
    preds, train_time, test_time = trainmodel_lstm(tdata)
